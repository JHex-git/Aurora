...
void VertexArray::SetAttribPointer(const VertexAttribPointer& attrib_pointer) const
{
    Bind();
...
void VertexArray::SetAttribPointers(const std::vector<VertexAttribPointer>& attrib_pointers) const
{
    Bind();
