...
{
public:
    static constexpr int kDirectionalCascadeCount = 4;
...
private:
    ...
    void RenderDirectionalLightShadow(ContextState& context_state, std::shared_ptr<Light> directional_light);
    ...
    void UpdateDirectionalLightCascades(std::shared_ptr<Light> directional_light);
    ...
    std::array<DirectionalCascadeData, kDirectionalCascadeCount> m_directional_cascades;
};
} // namespace Aurora
